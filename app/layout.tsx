...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={cn("min-h-screen bg-[#1E1E1E] font-sans antialiased", spaceGrotesk.variable)}>
          ...
          <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container flex h-20 max-w-screen-2xl items-center">
              ...
              <nav className="flex items-center space-x-8 text-sm font-medium ml-auto">
                ...
                <Link href="/about" className="transition-colors hover:text-white/80 text-white/90">
                  ABOUT ME
                </Link>
                <Link href="/works" className="transition-colors hover:text-white/80 text-white/90">
                  MY WORKS
                </Link>
                <Link
                  href="/contact"
  ...
  <div className="text-center space-y-4">
    ...
    <a href="mailto:info@aaronn.com" className="text-2xl font-bold hover:underline inline-block border-b border-white/10 pb-2">
      info@aaronn.com
    </a>
  </div>
  ...
  <div className="text-center text-sm text-white/40 mt-8">© 2023. Ideapeel. All rights reserved.</div>
</footer>
        </div>
      </body>
    </html>
